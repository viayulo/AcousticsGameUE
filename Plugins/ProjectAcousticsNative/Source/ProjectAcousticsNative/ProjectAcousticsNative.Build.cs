...
public class ProjectAcousticsNative : ModuleRules
{
    public ProjectAcousticsNative(ReadOnlyTargetRules Target) : base(Target)
    {
        ...
        if (Target.Platform == UnrealTargetPlatform.Android)
        {
            ...
            AdditionalPropertiesForReceipt.Add("AndroidPlugin", Path.Combine(PluginPath, "ProjectAcousticsNative_APL.xml"));
